            ...
            <form onSubmit={handleSave} className="space-y-4">
              <div>
                <label className="block text-[10px] font-bold text-slate-500 uppercase tracking-wider mb-1.5">
                  Tên danh mục <span className="text-purple-600">*</span>
                </label>
                <input
                  type="text"
                  required
                  ...
                  >
                    ...
                    <div className="text-center">
                      <span className="text-xs font-bold text-slate-800 block">
                        Kéo thả hoặc{" "}
                        <label className="text-red-550 hover:text-red-600 cursor-pointer underline inline text-red-500">
                          chọn file
                          <input
                            type="file"
              ...
              <div className="flex items-center justify-between p-3 bg-slate-50 rounded-xl border border-slate-200">
                <div>
                  <h4 className="text-xs font-bold text-slate-800">Hiển thị danh mục</h4>
                  <p className="text-[10px] text-slate-450 font-bold mt-0.5 text-slate-500">Nếu tắt, danh mục này sẽ bị ẩn khỏi menu</p>
                </div>
