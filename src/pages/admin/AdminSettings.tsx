      ...
      <form onSubmit={handleSaveSettings} className="space-y-6">
        ...
        <div className="bg-white border border-slate-200 rounded-3xl p-6 space-y-6 shadow-sm">
          <div className="border-b border-slate-100 pb-3 flex items-center gap-2">
            ...
            <h3 className="text-sm font-extrabold text-slate-900 uppercase tracking-wider">Nhận diện thương hiệu & Banners</h3>
          </div>
            ...
            <div className="md:col-span-3 space-y-2">
              ...
              <div className="flex gap-2">
                <input
                  ...
                  className="flex-1 px-4 py-2.5 bg-white border border-slate-200 rounded-xl focus:border-purple-600 focus:ring-1 focus:ring-purple-600 focus:outline-hidden text-xs font-semibold text-slate-800"
                />
                <label className="px-4 py-2.5 bg-slate-100 hover:bg-slate-200 text-slate-700 font-extrabold rounded-xl text-xs transition-colors flex items-center gap-1.5 cursor-pointer border border-slate-200 shrink-0 select-none">
              ...
              <p className="text-[10px] text-slate-400 font-bold">Hình ảnh logo chính thức xuất hiện trên thanh điều hướng.</p>
            </div>
          </div>
          ...
          <div className="space-y-4 pt-4 border-t border-slate-100">
            ...
            <div className="flex gap-2">
              ...
              <button
                ...
                className="px-4 py-2.5 bg-purple-600 hover:bg-purple-700 text-white font-extrabold rounded-xl text-xs transition-colors flex items-center gap-1 cursor-pointer border-0 shadow-sm"
              >
            ...
            {/* Active Banners list */}
            {banners.length === 0 ? (
              <div className="text-center py-6 bg-slate-50 border border-slate-200 border-dashed rounded-2xl text-xs text-slate-400 font-bold">
                Chưa có banner nào được thêm. Trang chủ sẽ hiển thị mặc định.
              </div>
            ) : (
              <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
                {banners.map((url, index) => (
                  <div key={index} className="relative group overflow-hidden bg-slate-50 border border-slate-200 rounded-2xl p-2 flex flex-col gap-2 shadow-xs">
                    {/* Thumbnail preview */}
                    <div className="w-full h-24 bg-white rounded-lg overflow-hidden border border-slate-150 flex items-center justify-center">
                      <img
                        src={getImageUrl(url)}
                        alt={`Banner ${index}`}
                    ...
                    {/* URL text */}
                    <div className="text-[9px] text-slate-500 truncate px-1 font-semibold">{url}</div>
                    {/* Delete button */}
                    <button
                      type="button"
                      onClick={() => handleRemoveBanner(index)}
                      className="absolute top-3 right-3 p-1.5 bg-white hover:bg-red-50 border border-slate-200 hover:border-red-200 rounded-lg text-red-600 cursor-pointer transition-colors shadow-xs"
                      title="Xóa banner"
                    >
        ...
        <div className="bg-white border border-slate-200 rounded-3xl p-6 space-y-6 shadow-sm">
          <div className="border-b border-slate-100 pb-3 flex items-center gap-2">
            ...
            <h3 className="text-sm font-extrabold text-slate-900 uppercase tracking-wider">Cấu hình Banner Hero (Banner To)</h3>
          </div>
            ...
            <div className="md:col-span-3 space-y-4">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="space-y-1.5">
                  ...
                  <input
                    ...
                    className="w-full px-4 py-2.5 bg-white border border-slate-200 rounded-xl focus:border-purple-600 focus:ring-1 focus:ring-purple-600 focus:outline-hidden text-xs font-semibold text-slate-800"
                  />
                </div>
                <div className="space-y-1.5">
                  <label className="block text-[10px] font-bold text-slate-500 uppercase tracking-wider">
              ...
              <div className="space-y-1.5">
                ...
                <textarea
                  ...
                  className="w-full px-4 py-2.5 bg-white border border-slate-200 rounded-xl focus:border-purple-600 focus:ring-1 focus:ring-purple-600 focus:outline-hidden text-xs font-semibold text-slate-800 resize-none"
                />
              </div>
        ...
        <div className="bg-white border border-slate-200 rounded-3xl p-6 space-y-6 shadow-sm">
          <div className="border-b border-slate-100 pb-3 flex items-center gap-2">
            <ImageIcon className="w-5 h-5 text-purple-600" />
            <h3 className="text-sm font-extrabold text-slate-900 uppercase tracking-wider">Cấu hình 3 Banner Nhỏ (Dưới Banner Hero)</h3>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {smallBanners.map((banner, index) => (
              <div key={index} className="bg-slate-50 border border-slate-200 rounded-2xl p-4 space-y-4 flex flex-col shadow-xs">
                <div className="border-b border-slate-200 pb-2 flex items-center justify-between">
                  <span className="text-[10px] font-extrabold text-purple-600 uppercase tracking-wider">Banner {index + 1}</span>
                  <span className="text-[9px] text-slate-400 font-bold">Vị trí {index + 1}</span>
                </div>
                ...
                <div className="space-y-1">
                  ...
                  <input
                    ...
                    className="w-full px-3 py-2 bg-white border border-slate-200 rounded-lg focus:border-purple-600 focus:ring-1 focus:ring-purple-600 focus:outline-hidden text-xs font-semibold text-slate-800"
                  />
                </div>
                ...
                <div className="space-y-1">
                  ...
                  <textarea
                    ...
                    className="w-full px-3 py-2 bg-white border border-slate-200 rounded-lg focus:border-purple-600 focus:ring-1 focus:ring-purple-600 focus:outline-hidden text-xs font-semibold text-slate-800 resize-none"
                  />
                </div>
                ...
                <div className="space-y-1">
                  ...
                  <div className="flex gap-1.5">
                    <input
                      ...
                      placeholder="URL ảnh"
                      className="flex-1 px-3 py-2 bg-white border border-slate-200 rounded-lg focus:border-purple-600 focus:ring-1 focus:ring-purple-600 focus:outline-hidden text-[11px] font-semibold text-slate-800"
                    />
                    <label className="px-2.5 py-2 bg-slate-100 hover:bg-slate-200 text-slate-700 font-extrabold rounded-lg text-xs transition-colors flex items-center justify-center border border-slate-200 cursor-pointer shrink-0 select-none">
                      <Upload className="w-3.5 h-3.5" />
                      <input
                        type="file"
                        accept="image/*"
        ...
        <div className="bg-white border border-slate-200 rounded-3xl p-6 space-y-6 shadow-sm">
          <div className="border-b border-slate-100 pb-3 flex items-center gap-2">
            ...
            <h3 className="text-sm font-extrabold text-slate-900 uppercase tracking-wider">Thông tin liên hệ & Mạng xã hội</h3>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
            ...
            <div className="space-y-1.5">
              <label className="block text-[10px] font-bold text-slate-500 uppercase tracking-wider flex items-center gap-1">
                <MapPin className="w-3.5 h-3.5 text-purple-600" /> Địa chỉ cửa hàng
              </label>
              <input
                type="text"
                value={address}
            ...
            <div className="space-y-1.5">
              <label className="block text-[10px] font-bold text-slate-500 uppercase tracking-wider flex items-center gap-1">
                <Phone className="w-3.5 h-3.5 text-purple-600" /> Hotline hỗ trợ
              </label>
              <input
                type="text"
                value={phone}
            ...
            <div className="space-y-1.5">
              <label className="block text-[10px] font-bold text-slate-500 uppercase tracking-wider flex items-center gap-1">
                <Mail className="w-3.5 h-3.5 text-purple-600" /> Email chăm sóc khách hàng
              </label>
              <input
                type="email"
                value={email}
            ...
            {/* Social Links */}
            <div className="space-y-1.5 md:col-span-2 grid grid-cols-1 sm:grid-cols-3 gap-4 pt-2 border-t border-slate-100">
              {/* Facebook */}
              <div className="space-y-1.5">
                <label className="block text-[10px] font-bold text-slate-500 uppercase tracking-wider flex items-center gap-1">
                  <Link2 className="w-3.5 h-3.5 text-blue-600" /> Fanpage Facebook
                </label>
                <input
                  type="text"
                  value={facebook}
              ...
              <div className="space-y-1.5">
                <label className="block text-[10px] font-bold text-slate-500 uppercase tracking-wider flex items-center gap-1">
                  <Link2 className="w-3.5 h-3.5 text-pink-600" /> Instagram URL
                </label>
                <input
                  type="text"
                  value={instagram}
              ...
              <div className="space-y-1.5">
                <label className="block text-[10px] font-bold text-slate-500 uppercase tracking-wider flex items-center gap-1">
                  <Link2 className="w-3.5 h-3.5 text-red-600" /> Youtube channel
                </label>
                <input
                  type="text"
                  value={youtube}
        ...
        <div className="flex justify-end">
          <button
            type="submit"
            disabled={isSaving}
            className="px-6 py-3 bg-purple-600 hover:bg-purple-700 text-white font-extrabold rounded-xl text-xs transition-colors flex items-center gap-1.5 cursor-pointer border-0 shadow-lg shadow-purple-600/15"
          >
